...
class CognitoService extends Service {
  static {
    g(this.prototype, "session", [service]);
  }
  #session = (i(this, "session"), void 0);
  static {
    g(this.prototype, "clientId", [tracked]);
  }
  #clientId = (i(this, "clientId"), void 0);
  static {
    g(this.prototype, "poolId", [tracked]);
  }
  #poolId = (i(this, "poolId"), void 0);
  auth = Auth;
  constructor() {
    super(...arguments);
...
var __glob__1_1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: CognitoService
});

export { CognitoService as C, __glob__1_1 as _ };
//# sourceMappingURL=cognito-hDPf7V8c.js.map
