 ...
 * @param attributes
 */
function normalizeAttributes(attributes, showDeprecation = true) {
  ...
  if (typeOf(attributes) === 'array') {
    deprecate('You can pass a hash to this function rather than a list of CognitoUserAttribute objects.', !showDeprecation, {
      for: 'ember-cognito',
